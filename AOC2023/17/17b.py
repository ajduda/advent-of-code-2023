...
while True:
    ...
    if y == finalY and x == finalX:
        print(cost)
        exit()
    #This below section is very code repeaty and I didn't notice until I was almost done, oops.
